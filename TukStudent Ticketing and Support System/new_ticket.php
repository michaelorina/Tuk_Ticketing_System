				...
				<input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
					...
					<?php if($_SESSION['login_type'] != 3): ?>
						<div class="form-group">
							...
							<select name="student_id" id="student_id" class="custom-select custom-select-sm select2">
								<option value=""></option>
							<?php
								$department = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as name FROM students order by concat(lastname,', ',firstname,' ',middlename) asc");
