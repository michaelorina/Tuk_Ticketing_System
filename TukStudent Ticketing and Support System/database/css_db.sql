...
CREATE TABLE `comments` (
  ...
  `user_type` tinyint(1) NOT NULL COMMENT '1= admin, 2= staff,3= student',
...
INSERT INTO `students` (`id`, `firstname`, `lastname`, `middlename`, `contact`, `address`, `email`, `password`, `date_created`) VALUES
...
INSERT INTO `tickets` (`id`, `subject`, `description`, `status`, `department_id`, `student_id`, `staff_id`, `admin_id`, `date_created`) VALUES
