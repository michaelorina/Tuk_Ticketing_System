			...
			<table class="table table-hover table-bordered" id="list">
				...
				<tbody>
					...
					if($_SESSION['login_type'] == 3)
						$where .= " where t.student_id = {$_SESSION['login_id']} ";
					$qry = $conn->query("SELECT t.*,concat(c.lastname,', ',c.firstname,' ',c.middlename) as cname FROM tickets t inner join students c on c.id= t.student_id $where order by unix_timestamp(t.date_created) desc");
